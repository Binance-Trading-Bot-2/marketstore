...
plugins](https://github.com/Binance-Trading-Bot-2/marketstore/tree/master/plugins#included)
...
[cmd](https://github.com/Binance-Trading-Bot-2/marketstore/tree/master/cmd) package
...
```sh
go install github.com/Binance-Trading-Bot-2/marketstore/v4@latest
...
``` sh
go get -u github.com/Binance-Trading-Bot-2/marketstore
```
...
```
example@alpaca:~/go/bin/src/github.com/Binance-Trading-Bot-2/marketstore$ marketstore
...
I0619 16:29:30.103179    7835 log.go:14] Root Directory: /example/go/bin/src/github.com/Binance-Trading-Bot-2/marketstore/project/data/mktsdb
...
I0619 16:29:30.244903    7835 log.go:14] Replay of WAL file /example/go/bin/src/github.com/Binance-Trading-Bot-2/marketstore/project/data/mktsdb/WALFile.1529450306968096708.walfile finished
...
### Python
[pymarketstore](https://github.com/Binance-Trading-Bot-2/pymarketstore) is the standard
